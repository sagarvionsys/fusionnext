...
const it_profile = () => {
  ...
  return (<main className='pt-[70px] bg-black'>
    ...
    <div className="w-full mx-auto rounded-md  h-[30rem] overflow-hidden">
      <Vortex
        ...
        <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-orange-300 to-orange-700 text-2xl md:text-6xl font-bold text-center">
          Work at <span className='bg-clip-text text-transparent bg-gradient-to-r from-orange-300 to-orange-700'>Fusion</span>
        </h2>
        <p className="text-white text-sm md:text-2xl max-w-xl mt-6 text-center">
         Discover how you can make an impact: see our areas of work, locations and opportunities for you.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-12">
          <Link href={"/ContactUs"} className="px-12 py-2 bg-blue-500 hover:bg-blue-700 transition duration-200 rounded-lg text-white shadow-[0px_2px_0px_0px_#FFFFFF40_inset]">
            Contact Us
          </Link>
        </div>
    ...
    <section className='h-[500px]'>
      <div className='absolute z-20 flex justify-start w-11/12 h-[500px]'>
       <div className='h-auto w-auto place-content-center'>
        ...
        <h1 className="leading-tight md:text-5xl text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">Welcome
    ...
    <section className='h-full px-3 py-12 bg-orange-50'>
        <div className="flex flex-col px-6 ">
          <h2 className="font-bold text-2xl pb-2 dark:text-gray-100">See our areas of Work & Opportunities for you</h2>
      ...
      {Jobs.map((it_profile, index) => (<div  key={index} className="border w-full max-w-sm bg-white mx-3 rounded-lg shadow-2xl mt-5 dark:shadow-blue-900 hover:shadow-xl hover:transform hover:scale-105 duration-300">
        <div className='flex flex-col justify-evenly h-full'>
        <div className="flex flex-col h-full items-center md:items-start px-6 py-4">
        <div className="flex flex-col ">
          <h2 className="font-bold text-xl dark:text-gray-100">{it_profile.position}</h2>
          <div className="border-2 border-blue-500 mb-3 text"></div>
        </div>
       ...
       <div className="flex flex-col h-auto w-auto items-center md:items-start bg-gray-100 px-6 py-3 rounded-lg dark:bg-blue-100">
        <p className="text-gray-600 w-full h-auto dark:text-gray-600 ">{it_profile.EmploymentType}</p>
        <p className="text-gray-600 w-full h-auto dark:text-gray-600 ">{it_profile.Experience}</p>
        <p className="text-gray-600 w-full h-auto dark:text-gray-600 ">{it_profile.education}</p>
        <p className="text-gray-600 w-full h-auto dark:text-gray-600 ">{it_profile.Location}</p>
        <button className="bg-blue-600 px-6 py-2 mt-3 rounded font-semibold text-white hover:bg-blue-700 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300" onClick={showModal}>Apply</button>
        </div>
       </div>
       </div>
       ))}
       ...
       <div className="[ lg:flex lg:items-center ] [ fancy-corners fancy-corners--large fancy-corners--top-left fancy-corners--bottom-right ]">
        ...
        <div className="py-6 px-8 bg-grey">
          <div className="leading-relaxed">
            <h2 className="leading-tight text-4xl font-bold">Your career awaits.</h2>
            <p className="mt-4 ">Republic is more than just a "tech job". We're making real, lasting careers in the exciting world of technology, helping people stay in touch in incredible new ways. Your role is guaranteed to be fast-paced, but the experience will last forever.</p>
