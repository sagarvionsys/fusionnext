        ...
        <div className="bg-white text-black dark:bg-black dark:text-white">
          <div className="px-5 md:px-10 lg:px-20 py-6"> {/* Add padding */}
              ...
              <div className="w-full md:w-1/2 flex-shrink-0 mb-6 md:mb-0 md:mr-6"> {/* Set width to 100% on mobile, 50% on larger screens */}
                ...
                >
                  <div className=" ">
                    ...
                    <img className="w-80 h-80  rounded-lg border border-wheat-60" src="https://plus.unsplash.com/premium_photo-1682787494863-177371a38ab9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z3JvdXAlMjBvZiUyMHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D" />

                  </div>


                  <div>
                    <img className="w-80 h-80 rounded-lg border border-wheat-60" src="https://images.unsplash.com/photo-1576267423445-b2e0074d68a4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Z3JvdXAlMjBvZiUyMHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D" />
                  </div>

                  <div>
                    <img className="w-80 h-80 rounded-lg border border-wheat-60" src="https://images.unsplash.com/photo-1549057446-9f5c6ac91a04?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Z3JvdXAlMjBvZiUyMHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D" />
                  </div>
                  <div>
                    <img className="w-80 h-80  rounded-lg border border-wheat-60" src="https://images.unsplash.com/photo-1549057446-9f5c6ac91a04?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Z3JvdXAlMjBvZiUyMHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D" />
                  ...
                  <div>
                    <img className="w-80 h-80  rounded-lg border border-wheat-60" src="https://plus.unsplash.com/premium_photo-1678914346886-c431f389db85?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Z3JvdXAlMjBvZiUyMHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D" />
                  </div>
                </Carousel>
              </div>
            ...
            <div className='p-5 text-indigo-400'>
              <p className='font-serif justify-center p-4 m-4 text-center  text-red-400 text-[40px] '>100% PLACEMENT ASSISTANCE</p>
