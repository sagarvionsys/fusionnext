        ...
        <div className="container mx-auto my-4 px-4 lg:px-20">
          <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto dark:bg-gray-900 rounded-2xl shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
              <input
                className="w-full bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-slate-200 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                type="text"
                placeholder="First Name*"
              />
              <input
                className="w-full bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-gray-200 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                type="text"
